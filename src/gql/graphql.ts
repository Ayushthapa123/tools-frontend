...
export const UpdateAmenityOption = gql`
  ...
  updateAmenityOption(
    ...
    `;
export const GetHostelApplicationFormsByUserId = gql`
    query GetHostelApplicationFormsByUserId($pageSize: Int = 50, $pageNumber: Int = 1) {
