...
export type Query = {
  ...
  findAllAmenities: Array<Amenity>;
  findAmenityByHomestayId: Array<Amenity>;
  findAnAmenityById: Amenity;
...
export type ValidInvalidBooking = {
  ...
  bookingSummary?: Maybe<Scalars['String']['output']>;
...
export type CheckValidBookingQuery = { __typename?: 'Query', checkValidBooking: { __typename?: 'ValidInvalidBooking', isValid: boolean, message?: string | null, totalPrice?: number | null, totalDays?: number | null, bookingSummary?: string | null } };
