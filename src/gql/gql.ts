 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation UpdateHostelGuest($updateHostelGuestInput: UpdateHostelGuestInput!) {\n  updateHostelGuest(updateHostelGuestInput: $updateHostelGuestInput) {\n    data {\n      id\n    }\n    error {\n      message\n    }\n  }\n}"): (typeof documents)["mutation UpdateHostelGuest($updateHostelGuestInput: UpdateHostelGuestInput!) {\n  updateHostelGuest(updateHostelGuestInput: $updateHostelGuestInput) {\n    data {\n      id\n    }\n    error {\n      message\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetAllHostels($pageSize: Int, $pageNumber: Int) {\n  getAllHostels(pageSize: $pageSize, pageNumber: $pageNumber) {\n    data {\n      id\n      name\n      description\n      slug\n      verifiedByCommunityOwner\n      verifiedBySuperAdmin\n      ownerId\n      createdAt\n      updatedAt\n      address {\n        id\n        country\n        city\n        subCity\n        street\n        latitude\n        longitude\n      }\n      contact {\n        id\n        phone\n        altPhone\n        email\n      }\n      rooms {\n        id\n        status\n        capacity\n        caption\n        description\n        roomNumber\n        maxOccupancy\n        attachBathroom\n        price {\n          id\n          baseAmountPerDay\n          baseAmountPerMonth\n          currency\n          discountAmount\n          discountType\n          isDynamicPricing\n          isDiscountActive\n        }\n        image {\n          id\n          caption\n          url\n        }\n      }\n      gallery {\n        id\n        caption\n        url\n      }\n    }\n    error {\n      message\n      code\n    }\n  }\n}"): (typeof documents)["query GetAllHostels($pageSize: Int, $pageNumber: Int) {\n  getAllHostels(pageSize: $pageSize, pageNumber: $pageNumber) {\n    data {\n      id\n      name\n      description\n      slug\n      verifiedByCommunityOwner\n      verifiedBySuperAdmin\n      ownerId\n      createdAt\n      updatedAt\n      address {\n        id\n        country\n        city\n        subCity\n        street\n        latitude\n        longitude\n      }\n      contact {\n        id\n        phone\n        altPhone\n        email\n      }\n      rooms {\n        id\n        status\n        capacity\n        caption\n        description\n        roomNumber\n        maxOccupancy\n        attachBathroom\n        price {\n          id\n          baseAmountPerDay\n          baseAmountPerMonth\n          currency\n          discountAmount\n          discountType\n          isDynamicPricing\n          isDiscountActive\n        }\n        image {\n          id\n          caption\n          url\n        }\n      }\n      gallery {\n        id\n        caption\n        url\n      }\n    }\n    error {\n      message\n      code\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
