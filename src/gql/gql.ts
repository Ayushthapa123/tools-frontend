 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query getFilteredHostels($input: SearchFilteredHostelInput!) {\n  getFilteredHostels(input: $input) {\n    data {\n      name\n      description\n      address {\n        city\n        country\n        subCity\n        street\n      }\n      rooms {\n        price {\n          baseAmountPerDay\n          baseAmountPerMonth\n        }\n      }\n      contact {\n        phone\n        email\n        altPhone\n      }\n      gallery {\n        url\n      }\n      slug\n    }\n    error {\n      message\n      code\n    }\n  }\n}"): (typeof documents)["query getFilteredHostels($input: SearchFilteredHostelInput!) {\n  getFilteredHostels(input: $input) {\n    data {\n      name\n      description\n      address {\n        city\n        country\n        subCity\n        street\n      }\n      rooms {\n        price {\n          baseAmountPerDay\n          baseAmountPerMonth\n        }\n      }\n      contact {\n        phone\n        email\n        altPhone\n      }\n      gallery {\n        url\n      }\n      slug\n    }\n    error {\n      message\n      code\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
