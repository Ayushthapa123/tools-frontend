 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query CheckValidBooking($roomId: Int!, $startDate: DateTime!, $endDate: DateTime!) {\n  checkValidBooking(roomId: $roomId, startDate: $startDate, endDate: $endDate) {\n    isValid\n    message\n    status\n  }\n}"): (typeof documents)["query CheckValidBooking($roomId: Int!, $startDate: DateTime!, $endDate: DateTime!) {\n  checkValidBooking(roomId: $roomId, startDate: $startDate, endDate: $endDate) {\n    isValid\n    message\n    status\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
