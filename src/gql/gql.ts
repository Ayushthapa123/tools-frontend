 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation CreateListedAiTool($data: CreateListedAiToolInput!) {\n  createListedAiTool(data: $data) {\n    data {\n      id\n      name\n    }\n    error {\n      message\n      code\n      path\n    }\n  }\n}"): (typeof documents)["mutation CreateListedAiTool($data: CreateListedAiToolInput!) {\n  createListedAiTool(data: $data) {\n    data {\n      id\n      name\n    }\n    error {\n      message\n      code\n      path\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation DeleteListedAiTool($toolId: Float!) {\n  deleteListedAiTool(toolId: $toolId) {\n    data {\n      id\n    }\n    error {\n      message\n      code\n      path\n    }\n  }\n}"): (typeof documents)["mutation DeleteListedAiTool($toolId: Float!) {\n  deleteListedAiTool(toolId: $toolId) {\n    data {\n      id\n    }\n    error {\n      message\n      code\n      path\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetAllListedAiTools($pageSize: Int = 200, $pageNumber: Int = 1, $isSuperAdmin: Boolean = false) {\n  getAllListedAiTools(\n    pageSize: $pageSize\n    pageNumber: $pageNumber\n    isSuperAdmin: $isSuperAdmin\n  ) {\n    data {\n      id\n      name\n      slug\n      shortDescription\n      logoUrl\n      websiteUrl\n      pricingType\n      aiType\n      domains\n      modalities\n      toolUserTypes\n      platforms\n      integrationOptions\n      popularityScore\n      featured\n      verified\n      useCases\n      createdAt\n      updatedAt\n    }\n    error {\n      message\n      code\n      path\n    }\n  }\n}"): (typeof documents)["query GetAllListedAiTools($pageSize: Int = 200, $pageNumber: Int = 1, $isSuperAdmin: Boolean = false) {\n  getAllListedAiTools(\n    pageSize: $pageSize\n    pageNumber: $pageNumber\n    isSuperAdmin: $isSuperAdmin\n  ) {\n    data {\n      id\n      name\n      slug\n      shortDescription\n      logoUrl\n      websiteUrl\n      pricingType\n      aiType\n      domains\n      modalities\n      toolUserTypes\n      platforms\n      integrationOptions\n      popularityScore\n      featured\n      verified\n      useCases\n      createdAt\n      updatedAt\n    }\n    error {\n      message\n      code\n      path\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetListedAiToolsByUserToken($pageSize: Int = 30, $pageNumber: Int = 1) {\n  getListedAiToolsByUserToken(pageSize: $pageSize, pageNumber: $pageNumber) {\n    data {\n      id\n      name\n      slug\n      shortDescription\n      logoUrl\n      websiteUrl\n      pricingType\n      aiType\n      toolUserTypes\n      keywords\n      platforms\n      integrationOptions\n      popularityScore\n      featured\n      verified\n      useCases\n      createdAt\n      updatedAt\n    }\n    error {\n      message\n      code\n      path\n    }\n  }\n}"): (typeof documents)["query GetListedAiToolsByUserToken($pageSize: Int = 30, $pageNumber: Int = 1) {\n  getListedAiToolsByUserToken(pageSize: $pageSize, pageNumber: $pageNumber) {\n    data {\n      id\n      name\n      slug\n      shortDescription\n      logoUrl\n      websiteUrl\n      pricingType\n      aiType\n      toolUserTypes\n      keywords\n      platforms\n      integrationOptions\n      popularityScore\n      featured\n      verified\n      useCases\n      createdAt\n      updatedAt\n    }\n    error {\n      message\n      code\n      path\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetListedAiToolsByUserType($pageNumber: Int = 1, $pageSize: Int = 6, $userType: ToolUserType!) {\n  getListedAiToolsByUserType(\n    pageNumber: $pageNumber\n    pageSize: $pageSize\n    userType: $userType\n  ) {\n    data {\n      id\n      name\n      slug\n      shortDescription\n      logoUrl\n      websiteUrl\n      pricingType\n      aiType\n      domains\n      modalities\n      toolUserTypes\n      platforms\n      integrationOptions\n      popularityScore\n      featured\n      verified\n      useCases\n      createdAt\n      updatedAt\n    }\n    error {\n      message\n      code\n      path\n    }\n  }\n}"): (typeof documents)["query GetListedAiToolsByUserType($pageNumber: Int = 1, $pageSize: Int = 6, $userType: ToolUserType!) {\n  getListedAiToolsByUserType(\n    pageNumber: $pageNumber\n    pageSize: $pageSize\n    userType: $userType\n  ) {\n    data {\n      id\n      name\n      slug\n      shortDescription\n      logoUrl\n      websiteUrl\n      pricingType\n      aiType\n      domains\n      modalities\n      toolUserTypes\n      platforms\n      integrationOptions\n      popularityScore\n      featured\n      verified\n      useCases\n      createdAt\n      updatedAt\n    }\n    error {\n      message\n      code\n      path\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetListedAiToolById($toolId: Float!) {\n  getListedAiToolById(toolId: $toolId) {\n    data {\n      id\n      name\n      slug\n      shortDescription\n      logoUrl\n      websiteUrl\n      pricingType\n      aiType\n      toolUserTypes\n      keywords\n      platforms\n      integrationOptions\n      popularityScore\n      featured\n      verified\n      useCases\n      createdAt\n      updatedAt\n    }\n    error {\n      message\n      code\n      path\n    }\n  }\n}"): (typeof documents)["query GetListedAiToolById($toolId: Float!) {\n  getListedAiToolById(toolId: $toolId) {\n    data {\n      id\n      name\n      slug\n      shortDescription\n      logoUrl\n      websiteUrl\n      pricingType\n      aiType\n      toolUserTypes\n      keywords\n      platforms\n      integrationOptions\n      popularityScore\n      featured\n      verified\n      useCases\n      createdAt\n      updatedAt\n    }\n    error {\n      message\n      code\n      path\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetListedAiToolBySlug($slug: String!) {\n  getListedAiToolBySlug(slug: $slug) {\n    data {\n      id\n      name\n      slug\n      shortDescription\n      logoUrl\n      websiteUrl\n      pricingType\n      aiType\n      aiCapabilities\n      modalities\n      delivery\n      toolUserTypes\n      keywords\n      platforms\n      integrationOptions\n      domains\n      popularityScore\n      featured\n      verified\n      useCases\n      createdAt\n      updatedAt\n    }\n    error {\n      message\n      code\n      path\n    }\n  }\n}"): (typeof documents)["query GetListedAiToolBySlug($slug: String!) {\n  getListedAiToolBySlug(slug: $slug) {\n    data {\n      id\n      name\n      slug\n      shortDescription\n      logoUrl\n      websiteUrl\n      pricingType\n      aiType\n      aiCapabilities\n      modalities\n      delivery\n      toolUserTypes\n      keywords\n      platforms\n      integrationOptions\n      domains\n      popularityScore\n      featured\n      verified\n      useCases\n      createdAt\n      updatedAt\n    }\n    error {\n      message\n      code\n      path\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation UpdateListedAiTool($toolId: Float!, $data: UpdateListedAiToolInput!) {\n  updateListedAiTool(toolId: $toolId, data: $data) {\n    data {\n      id\n    }\n    error {\n      message\n      code\n      path\n    }\n  }\n}"): (typeof documents)["mutation UpdateListedAiTool($toolId: Float!, $data: UpdateListedAiToolInput!) {\n  updateListedAiTool(toolId: $toolId, data: $data) {\n    data {\n      id\n    }\n    error {\n      message\n      code\n      path\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation VerifyListedAiTool($toolId: Int!, $status: Boolean!) {\n  verifyListedAiTool(toolId: $toolId, status: $status) {\n    data {\n      id\n      name\n    }\n    error {\n      message\n      code\n      path\n    }\n  }\n}"): (typeof documents)["mutation VerifyListedAiTool($toolId: Int!, $status: Boolean!) {\n  verifyListedAiTool(toolId: $toolId, status: $status) {\n    data {\n      id\n      name\n    }\n    error {\n      message\n      code\n      path\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
