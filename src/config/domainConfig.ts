...
export const domainConfig = {
  ...
  fullLogo: appName === 'hosteladmin' ? '/logo512.png' : '/logohp-full.png',
  appSlogan: appName === 'hosteladmin' ? 'Hostel Management System-Manage and grow your hostel business' : 'Hostelpilot-Search Nearby Hostels',
