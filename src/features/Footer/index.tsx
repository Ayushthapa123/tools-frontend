...
const Footer = () => {
  return (
    <footer>
      <div className="relative w-[100vw] z-10 flex items-center justify-center  bg-white/80 px-5 py-12 md:px-10 md:py-24">
      ...
      <div className='bg-primary'>
        <p className="text-white p-2 mb-0 text-left md:text-center text-sm md:text-base">
          &copy; 2025 <span className='font-semibold'>{domainConfig.appName}</span> . All Rights Reserved
        </p>
      </div>
    </footer>
  );
