...
import { MdHotel, MdEventAvailable, MdGroups, MdPerson, MdSearch, MdListAlt, MdMeetingRoom, MdContacts, MdWhatsapp } from "react-icons/md";
...
function Card({ icon, title, description }: { icon: React.ReactNode; title: string; description: React.ReactNode }) {
  return (
