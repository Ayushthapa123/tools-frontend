...
export const OfferCard = ({ title, description, imagePath ,index}: { title: string, description: string, imagePath  : string ,index:number}) => {
  return (
    <motion.div
      ...
      className={`bg-white rounded-xl border  p-4 shadow-lg  ${index === 2 ? 'min-h-[470px] border-gray-300' : 'min-h-[400px] border-gray-200'} hover:border-blue transition-all duration-100`}>
