      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="space-y-8 leading-relaxed text-gray-700">
          <section>
            ...
            <p>
              Welcome to <strong>hosteladmin.com</strong>. These terms and conditions outline the
              ...
              <strong>hosteladmin.com</strong> if you do not accept all the terms and conditions
              stated on this page.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              <strong>hosteladmin.com</strong>. You agree to:
            </p>
          ...
          <section>
            ...
            <p>
              <strong>hosteladmin.com</strong> is intended solely for managing hostel operations and
          ...
          <section>
            ...
            <p>
              All content and software associated with <strong>hosteladmin.com</strong> is the
              property of its developers or licensors. You may not:
            </p>
            <ul className="ml-6 list-disc">
              <li>
                Republish or redistribute materials from <strong>hosteladmin.com</strong> without
                permission.
              </li>
              <li>
          ...
          <section>
            ...
            <p>
              To the maximum extent permitted by law, <strong>hosteladmin.com</strong> shall not be
          ...
          <section>
            ...
            <p>
              ...
              <strong>hosteladmin.com</strong> is operated. Any disputes arising from these terms
