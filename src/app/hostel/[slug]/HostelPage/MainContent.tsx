          ...
          <div className="sticky top-[100px] m-3 lg:m-0 lg:min-w-[380px] lg:max-w-[380px]">
            <div className="space-y-6">
              ...
              <div className="rounded-xl bg-white p-6 pt-2 shadow-sm">
                ...
                <MapProvider>
                  <div>
                    <div className=" h-[350px] w-full overflow-y-hidden rounded-md">
                    ...
                    <div className="rounded-xl bg-white  pt-2 shadow-sm">
                      <h3 className="mb-2 text-lg font-semibold text-gray-800">
                        Your Desired Location
                      </h3>
                      {hostel?.data?.address?.latitude && (
                        <div className="  w-full  rounded-md">
                          <DistanceCalculation
                            lat={hostel?.data?.address?.latitude ?? 0}
                            lng={hostel?.data?.address?.longitude ?? 0}
                          />
                        </div>
                      )}
                    </div>
