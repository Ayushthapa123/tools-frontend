...
export const metadata: Metadata = {
  title: `Contact Us | Toolsland.ai`,
  description:
    `Contact Toolsland.ai for support, inquiries, or feedback. Find our phone, email, and office address here.`,
  manifest: '/manifest.json',
  authors: [{ name: 'Ayush Thapa' }],
  openGraph: {
    images: domainConfig.logo,
    title: `Contact Us | Toolsland.ai`,
    description: `Contact Toolsland.ai for support, inquiries, or feedback. Find our phone, email, and office address here.`,
  },
};
  ...
  return (
    <div className="flex min-h-[70vh] items-center justify-center bg-base-100 py-12 px-4">
      <div className="w-full max-w-xl rounded-2xl bg-white shadow-xl p-10 border border-gray-100">
        <h1 className="text-4xl font-extrabold text-primary mb-2 text-center">Contact Toolsland.ai</h1>
        ...
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-primary mb-2">Email Address</h2>
          <div className="text-gray-600 text-base">
            {/* Replace with real address if available */}
            <span>contact@toolsland.ai</span>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6 mb-8">
          ...
          <div className="flex items-center gap-4 bg-blue-50 rounded-lg p-4">
            ...
            <div>
              ...
              <a href="mailto:contact@toolsland.ai" className="text-blue-700 hover:underline text-base font-medium">contact@toolsland.ai</a>
            </div>
          </div>
        </div>
        <div className="mb-8">
        ...
        <div className="mt-6 text-center text-gray-400 text-sm">
          &copy; {new Date().getFullYear()} Toolsland.ai. All rights reserved.
        </div>
      </div>
    </div>
  );
