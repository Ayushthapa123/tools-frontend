    ...
    <div className="min-h-screen">
      <div className="navbar bg-base-200 shadow-lg">
        <div className="flex-1">
          <a className="btn btn-ghost text-xl">Theme Demo</a>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body">
              <h2 className="card-title">Light/Dark Mode Demo</h2>
              <p>This is a demo of DaisyUI&apos;s theme switching capabilities. Click the sun/moon icon in the navbar to toggle between light and dark modes.</p>
