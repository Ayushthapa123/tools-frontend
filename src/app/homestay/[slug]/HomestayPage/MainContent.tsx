...
export default function MainContent(props: Iprops) {
  ...
  //socials 
  const facebookUrl = homestay?.socials?.facebook ?? "#";
  const instagramUrl = homestay?.socials?.instaGram ?? "#";
  const youtubeUrl = homestay?.socials?.youTube ?? "#";
                  ...
                  <div>
                    ...
                    <div className="mt-2 flex items-center text-gray-600">
                      <CiLocationOn className="mr-1 text-2xl text-secondary" />
                        <span className="text-sm">{ homestay?.address?.subCity } {homestay?.address?.city}, {homestay?.address?.country}</span>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col items-start gap-0 md:flex-row lg:flex-col md:gap-4 lg:gap-0">
                    <div className="flex items-center gap-0">
                      <div className="flex h-10 w-10 items-center justify-center rounded-full bg-blue-50 text-blue-600 mb-3">
                        ...
                        <p className="ml-3 text-gray-700 text-base">{ homestay?.contact?.phone ?? "No number"}</p>
                    </div>
                    <div className="flex items-center">
                      <div className="flex h-10 w-10 items-center justify-center rounded-full bg-blue-50 text-blue-600 mb-3">
                        <MdEmail className='text-secondary h-8 w-7 lg:h-6 lg:w-6' />
                      </div>
                        <p className="ml-3 text-gray-700 text-base">{ homestay?.contact?.email ?? "No email"}</p>
                    </div>
