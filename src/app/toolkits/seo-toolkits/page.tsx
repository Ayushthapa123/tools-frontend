...
const seoToolkits = [
  {
    ...
    icon: <FaGlobe />,
    href: 'https://toolsland.ai/aitools/og-image-generator',
    category: 'SEO',
  },
  // HERE ADD MORE LIKE  FAQ GENERATOR,AI THUMBNAIL GENERATOR,  AI META TAGS GENERATOR, AI BLOG OUTLINE GENERATOR
  {
    ...
    icon: <FaKeyboard />,
    href: 'https://toolsland.ai/aitools/ai-faq-generator',
    category: 'SEO',
  },
  {
    ...
    icon: <FaRocket />,
    href: 'https://toolsland.ai/aitools/ai-thumbnail-generator',
    category: 'SEO',
  },
  {
    ...
    icon: <FaKeyboard />,
    href: 'https://toolsland.ai/aitools/meta-tag-generator-ai',
  ...
  },
  {
    ...
    icon: <FaChartLine />,
    href: 'https://toolsland.ai/aitools/ai-blog-outline-generator',
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: 'Toolkits',
        item: 'https://toolsland.ai/toolkits',
      },
      {
        '@type': 'ListItem',
        position: 2,
        name: 'SEO Toolkits',
        item: 'https://toolsland.ai/toolkits/seo-toolkits',
      },
    ],
  } as const;
